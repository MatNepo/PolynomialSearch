...
% Создание вектора множества занчений y общ.
y_average = [29.4629 29.4071 29.7242 29.9628 29.5854 29.5079]; 

% Инициализация пустого вектора для хранения решений
s_i = zeros(1,length(y_average));
% Подсчёт s_i
...
disp('Множество решений s_i:');
for k = 1:(length(y_average))
    % Вывод множества решений
    disp(['s_', num2str(k),' = ', sprintf('%.6f', s_i(k))]);
end